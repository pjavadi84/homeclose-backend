...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { available: @destination.available, capacity: @destination.capacity, description: @destination.description, price: @destination.price, zipcode: @destination.zipcode } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { available: @destination.available, capacity: @destination.capacity, description: @destination.description, price: @destination.price, zipcode: @destination.zipcode } }
